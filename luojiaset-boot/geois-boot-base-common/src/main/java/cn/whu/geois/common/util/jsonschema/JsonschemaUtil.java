package cn.whu.geois.common.util.jsonschema;
...
public class JsonschemaUtil {
	...
	public static JSONObject getJsonSchema(JsonSchemaDescrip descrip, List<CommonProperty> propertyList) {
		...
		//鬼知道这里为什么报错 cn.whu.geois.modules.system.model.DictModel cannot be cast to cn.whu.geois.modules.system.model.DictModel

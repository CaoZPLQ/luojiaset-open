...
import cn.whu.geois.modules.rssample.mapper.RssOrderItemMapper;
...
@Service
@DS("postgres")
public class RssOrderItemServiceImpl extends ServiceImpl<RssOrderItemMapper, RssOrderItem> implements IRssOrderItemService {
    @Transactional(rollbackFor = Exception.class)
    @Override
    public boolean insertBatch(List<RssOrderItem> entityList){
        return insertBatch(entityList,1000);
    }
    @Transactional(rollbackFor = Exception.class)
    @Override
    public boolean insertBatch(List<RssOrderItem> entityList,int batchSize){

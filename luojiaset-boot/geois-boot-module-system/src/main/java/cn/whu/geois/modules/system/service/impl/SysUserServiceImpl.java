...
import cn.whu.geois.modules.system.entity.*;
import cn.whu.geois.modules.system.mapper.*;
...
//		this.save(user);  //保存角色的时候已经添加过一次了
	...
	@Override
	public String getUserEmailAdress(String userId){
		return userMapper.getEmailByUser(userId);
	}

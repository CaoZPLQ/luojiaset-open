...
import cn.whu.geois.common.system.api.ISysBaseAPI;
import cn.whu.geois.common.system.util.JwtUtil;
import cn.whu.geois.common.system.vo.LoginUser;
import cn.whu.geois.common.util.*;
import cn.whu.geois.common.util.encryption.AesEncryptUtil;
import cn.whu.geois.common.util.encryption.EncryptedString;
import cn.whu.geois.modules.message.handle.impl.EmailSendMsgHandle;
import cn.whu.geois.modules.shiro.vo.DefContants;
import cn.whu.geois.modules.system.entity.SysDepart;
import cn.whu.geois.modules.system.entity.SysUser;
import cn.whu.geois.modules.system.model.SysLoginModel;
import cn.whu.geois.modules.system.service.ISysDepartService;
import cn.whu.geois.modules.system.service.ISysLogService;
...
//				SysUser sysUser = sysUserService.getUserByPhone(mobile);
				...
				if(sysUser!=null) {
					...
					sysBaseAPI.addLog("邮箱已经注册，请直接登录！", CommonConstant.LOG_TYPE_1, null);
					return result;
				}
//				b = DySmsHelper.sendSms(mobile, obj, DySmsEnum.REGISTER_TEMPLATE_CODE);
				EmailSendMsgHandle emailSendMsgHandle=new EmailSendMsgHandle();
				String esTitle="LuoJiaSet's verification code";
				String esContent="Dear "+username+":\nYour verification code:"+captcha+".This verification code is valid for ten minutes, please do not leak.";
				try {
                    emailSendMsgHandle.SendMsg(email,esTitle,esContent);
                    b=true;
                }catch (Exception e){
				    e.printStackTrace();
                }

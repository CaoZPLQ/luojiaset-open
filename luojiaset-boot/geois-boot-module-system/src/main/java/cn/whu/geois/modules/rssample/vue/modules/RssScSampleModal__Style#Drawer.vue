    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="sampleId">
          <a-input placeholder="请输入sampleId" v-decorator="['sampleId', validatorRules.sampleId ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="classId">
          <a-input placeholder="请输入classId" v-decorator="['classId', validatorRules.classId ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules:{
        sampleId:{rules: [{ required: true, message: '请输入sampleId!' }]},
        classId:{rules: [{ required: true, message: '请输入classId!' }]},
        },
        url: {
          add: "/rssample/rssScSample/add",
          edit: "/rssample/rssScSample/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sampleId','classId','datasetId','sampleWidth','sampleHeight','sampleArea','sampleDate','sampleQuality','sampleLabeler','annotationDate','imagePath','imageType','imageChannels','imageResolution','instrument','trnValueTest','thumb'))
		  //时间格式化
        });

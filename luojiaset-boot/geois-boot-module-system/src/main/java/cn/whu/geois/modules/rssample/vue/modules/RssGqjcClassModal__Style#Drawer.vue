  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/rssample/rssGqjcClass/add",
          edit: "/rssample/rssGqjcClass/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','level','parentId','description'))
		  //时间格式化
        });

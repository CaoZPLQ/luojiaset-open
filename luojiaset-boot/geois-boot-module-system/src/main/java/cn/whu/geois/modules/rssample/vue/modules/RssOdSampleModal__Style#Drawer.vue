    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="labelBbox">
          <a-input placeholder="请输入labelBbox" v-decorator="['labelBbox', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/rssample/rssOdSample/add",
          edit: "/rssample/rssOdSample/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'datasetId','sampleArea','sampleDate','sampleQuality','sampleLabeler','annotationDate','labelBbox','imagePath','labelPath','imageType','imageChannels','imageResolution','instrument','trnValueTest','sampleWidth','sampleHeight','thumb'))
		  //时间格式化
        });

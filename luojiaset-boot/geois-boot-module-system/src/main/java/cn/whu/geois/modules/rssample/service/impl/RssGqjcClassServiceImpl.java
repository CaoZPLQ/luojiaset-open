...
import cn.whu.geois.modules.rssample.mapper.RssGqjcClassMapper;
...
@Service
@DS("postgres")
public class RssGqjcClassServiceImpl extends ServiceImpl<RssGqjcClassMapper, RssGqjcClass> implements IRssGqjcClassService {
    @Transactional(rollbackFor = Exception.class)
    @Override
    public boolean insertBatch(List<RssGqjcClass> entityList){
        return insertBatch(entityList,1000);
    }
    @Transactional(rollbackFor = Exception.class)
    @Override
    public boolean insertBatch(List<RssGqjcClass> entityList, int batchSize){

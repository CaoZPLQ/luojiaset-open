<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('地物分类样本元数据表')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <rssLcSample-modal ref="modalForm" @ok="modalFormOk"></rssLcSample-modal>
  </a-card>
</template>

<script>
  import RssLcSampleModal from './modules/RssLcSampleModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'

  export default {
    name: "RssLcSampleList",
    ...
    data () {
      return {
		...
		url: {
          list: "/rssample/rssLcSample/list",
          delete: "/rssample/rssLcSample/delete",
          deleteBatch: "/rssample/rssLcSample/deleteBatch",
          exportXlsUrl: "rssample/rssLcSample/exportXls",
          importExcelUrl: "rssample/rssLcSample/importExcel",
       },
    }
  },
  computed: {

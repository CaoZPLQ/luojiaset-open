<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('目标检测样本元数据表')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <rssOdSample-modal ref="modalForm" @ok="modalFormOk"></rssOdSample-modal>
  </a-card>
</template>

<script>
  import RssOdSampleModal from './modules/RssOdSampleModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'

  export default {
    name: "RssOdSampleList",
    ...
    data () {
      return {
		...
		url: {
          list: "/rssample/rssOdSample/list",
          delete: "/rssample/rssOdSample/delete",
          deleteBatch: "/rssample/rssOdSample/deleteBatch",
          exportXlsUrl: "rssample/rssOdSample/exportXls",
          importExcelUrl: "rssample/rssOdSample/importExcel",
       },
    }
  },
  computed: {
